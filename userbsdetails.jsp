...
<th style="text-align:centre;color:black;" >Clutch/Break Issues</th>
...
<th style="text-align:centre;color:black;" width="10%">Filter Change</th>
<th style="text-align:centre;color:black;" width="10%">Repaint/Scratch Removal</th>
<th style="text-align:centre;color:black;" width="10%">Tyre Puncture/Replacement</th>
<th style="text-align:centre;color:black;" width="6%">Store Email</th>
<th style="text-align:centre;color:black;" width="10%">Action</th>
</tr>
<%while(rs.next())
{%>
<tr style="background-color: #ddd;">
...
<td style="text-align:centre;color:black;"><a href="bikeservicestatus.jsp?id=<%=rs.getString(1)%>">Book</a></td>
</tr>
<%}%>
</table>
</centre>
