...
<th style="text-align:centre;color:black;" width="6%">Bike Name</th>
<th style="text-align:centre;color:black;" width="10%">Bike Model</th>
<th style="text-align:centre;color:black;" width="10%">Description</th>
<th style="text-align:centre;color:black;" width="10%">User Email</th>
</tr>
<%while(rs.next())
{%>
<tr style="background-color: #ddd;">
