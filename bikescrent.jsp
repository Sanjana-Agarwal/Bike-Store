...
<th style="text-align:centre;color:black;">Bike Model</th>
<th style="text-align:centre;color:black;">Bike Type</th>
<th style="text-align:centre;color:black;">Rent</th>
<th style="text-align:centre;color:black;">Booking Date</th>
<th style="text-align:centre;color:black;">Customer Email</th>
<th style="text-align:centre;color:black;">Pickup Time</th>
<th style="text-align:centre;color:black;">Dropping Time</th>
<th style="text-align:centre;color:black;">Amount</th>
...
<td style="text-align:centre;color:black;"><%=rs.getInt(5)%></td>
<td style="text-align:centre;color:black;"><%=rs.getString(7)%></td>
<td style="text-align:centre;color:black;"><%=rs.getString(9)%></td>
<td style="text-align:centre;color:black;"><%=rs.getInt(11)%>:<%=rs.getInt(12)%></td>
<td style="text-align:centre;color:black;"><%=rs.getInt(13)%>:<%=rs.getInt(14)%></td>
<td style="text-align:centre;color:black;"><%=rs.getString(10)%></td>
<td style="text-align:centre;color:black;"><a href="caltime1.jsp?id=<%=rs.getString(1)%>">Click</a></td>
</tr>
<%}%>
</table>
</div>
