...
<th style="text-align:centre;color:black;" width="20%">Bike Name</th>
<th style="text-align:centre;color:black;" width="20%">Service Date</th>
<th style="text-align:centre;color:black;" width="25%">Customer Email</th>
</tr>
<%while(rs.next())
{%>
<tr style="background-color: #ddd;">
