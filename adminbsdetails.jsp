...
%>
<div class="details" style="padding-left: 200px;">
<table border="3" cellspacing="1" heidgt="200" width="800" style="text-align:centre;">
<tr style="background-color: #ddd;">
<th style="text-align:centre;color:black;" width="20%">Store Name</th>
<th style="text-align:centre;color:black;" width="25%">Email</th>
<th style="text-align:centre;color:black;" width="20%">Phone</th>
<th style="text-align:centre;color:black;" width="25%">Address</th>
<th style="text-align:centre;color:black;" width="25%">Pincode</th>
</tr>
<%while(rs.next())
{%>
<tr style="background-color: #ddd;">
