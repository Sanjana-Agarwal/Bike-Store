...
<th style="text-align:centre;color:black;" width="10%">No. Gears</th>
<th style="text-align:centre;color:black;" width="10%">Displacement</th>
<th style="text-align:centre;color:black;" width="10%">Milage</th>
<th style="text-align:centre;color:black;" width="10%">Top Speed</th>
<th style="text-align:centre;color:black;" width="10%">Battery</th>
<th style="text-align:centre;color:black;" width="6%">Price</th>
<th colspan="2" style="text-align:centre;color:black;" width="10%">Action</th>
...
<td style="text-align:centre;color:black;"><a href="bikespecupdate.jsp?id=<%=rs.getString(1)%>">Update</a></td>
<td style="text-align:centre;color:black;"><a href="bikespecdelete.jsp?id=<%=rs.getString(1)%>">Delete</a></td>
</tr>
<%}%>
</table>
</div>
